...
_Source: b0f.ru writeup - author states platform submit success (isSuccess: true). Supersedes our own prior 'deferred' note about needing an interpreter bug - worth re-testing our own binary against this exact flag on submit. - independently cross-checked, then live-submitted and ACCEPTED by FlagYard this session._
